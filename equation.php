...
{
    $text = array("Moyenne", "Variability", "Sum", "Standard deviation", "One variable is incorrect", "The system does not manage the complex numbers.",
    "Normal Distribution", "Resolve", "Result", "Uniform distribution (discrete)", "Poisson distribution", "Numbers of possibility",
    "Parameters", "Interval between K and K2", "Binomial distribution B(n, p)", "");
}
...
{
  $loi = new loi_normale($_POST['x_loi_normale'], $_POST['x1_loi_normale'], $_POST['esperance_loi_normale'], $_POST['ecart_type_loi_normale']);
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <div class="form-group center-block" style="margin-bottom: 0px;">
                          ...
                          <div class="col-md-4">
                          <input id="textinput" name="x_loi_normale" type="text" placeholder="X1" class="form-control input-md" />
                            
                          </div>
                          <div class="col-md-3" style="padding-left: 0px;">
                          <input id="textinput" name="x1_loi_normale" type="text" placeholder="X2" class="form-control input-md" />
                          </div>
                        </div>
                        <center><span class="help-block center-block">X1 < X < X2</span></center>
