...
{
    $text = array("Columns", "The system does not manage the complex numbers.", "Generate", "Line", "Calculate", "Data", "You have to choose the size of the array to generate it");
}
else if ($_SESSION['langue'] == 'fr')
{
    $text = array("Colonnes", "Le système ne prend pas en charge les nombres complexes.", "Génerer", "Lignes", "Calculer", "Données", "Vous devez choisir la taille du tableau de données pour le générer");
}
